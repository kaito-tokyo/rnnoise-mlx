...
Generate it with `training/scripts/export_bnns_bundle.py`. The
`export_bnns_graph.py` converter validates its structure and emits a Core ML
...
`training/scripts/convert_official_weights.py` imports official PyTorch
